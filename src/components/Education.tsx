...
export const Education: React.FC = () => {
  ...
  return (
    <section id="education" className="py-24 relative overflow-hidden bg-gradient-to-b from-[#05001a]/20 to-transparent">
        ...
        >
          {educationData.map((edu, idx) => (
            <motion.div
              ...
              className="glass-card rounded-2xl p-8 border border-white/5 relative overflow-hidden group hover:border-purple-500/20 hover:bg-[#10102b]/40 transition-all duration-300 text-left flex flex-col justify-between"
            >
              {/* Backlight visual orb */}
              <div className="absolute -bottom-12 -left-12 w-28 h-28 rounded-full bg-purple-500/5 blur-xl group-hover:bg-purple-500/10 transition-colors" />
              ...
              <div className="space-y-4 relative z-10">
                ...
                <div className="space-y-1 text-sm text-gray-400 font-medium">
                  <div className="flex items-center gap-2">
                    <Landmark className="w-4 h-4 text-purple-400/80 shrink-0" />
