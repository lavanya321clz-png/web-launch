...
'{
  ...
  "certificationsData": [
    ...
    {
      "name": "Database Administrator Specialist (PostgreSQL)",
      "issuer": "Microsoft",
      "year": "2022",
      "icon": "Database"
    },
  ...
  "servicesData": [
    ...
    },
    {
      ...
      "description": "Setting up continuous deployments, configuring server environments, and managing cloud server scaling.",
      "icon": "CloudLightning"
    }
  ],
  "testimonialsData": [
